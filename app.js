...
function genInforme(){
  ...
  const p3html=`<div class="page">${HT('Operaciones y movimientos')}<div class="body">
    <div class="grow col">${secbar('Operaciones desde inicio')}<div class="panel"><table><thead><tr><th>Fecha</th><th>Operación</th><th>Instrumento</th><th class="num">Importe €</th><th class="num">Precio</th><th class="num">Títulos</th></tr></thead><tbody>${orows||'<tr><td colspan="6" class="muted">Sin operaciones.</td></tr>'}</tbody></table></div></div>
